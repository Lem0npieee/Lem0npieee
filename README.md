<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Welcome%20to%20My%20GitHub!&fontSize=42&fontAlignY=32&desc=Full%20Stack%20Developer%20|%20Open%20Source%20Enthusiast&descAlignY=51&descAlign=50"/>
</div>

<div align="center">
  
  <!-- 动态打字效果 -->
  [![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=F75C7E&center=true&vCenter=true&width=435&lines=Hi+there!+I'm+%5B你的名字%5D+👋;Full+Stack+Developer+💻;Open+Source+Contributor+🌟;Always+Learning+New+Things+🚀)](https://git.io/typing-svg)
...
class Developer:
    def __init__(self):
        ...
        self.code = ["Python", "JavaScript", "TypeScript", "Java", "Go"]
        self.tools = ["React", "Node.js", "Docker", "Kubernetes", "AWS"]
...
🔭 目前在做: [你的项目名称]
🌱 正在学习: Rust, Web3, AI/ML
👯 希望合作: 开源项目
💬 问我关于: Python, React, DevOps
